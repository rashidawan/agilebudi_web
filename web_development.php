	...
	<div class="row">
    	<div class="container">
            ...
            <h2>Web Development</h2>
            	<p>Development of websites and portals is highly creative endeavor. The end-user experience makes all the difference in making the web portals and websites stand out in the crowd. Our experienced resources have the knack for making our clients web portal and websites stand out and retain the visitors for a longer duration.</p>
                
                
            </div>
            <div class="col-md-3 padding-margin-none">
